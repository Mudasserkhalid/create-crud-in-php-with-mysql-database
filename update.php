...
if (isset($_POST["id"]) && !empty($_POST["id"])) {
    ...
    if (empty($name_err) && empty($address_err) && empty($fathername_err)) {
        // Prepare an update statement
        $name       = $_POST['name'];
        $fathername = $_POST['fathername'];
		$address    = $_POST['address'];

		mysqli_query($link, "Update students SET name='$name',fathername='$fathername',address='$address'  WHERE id='$id'"); 
        // Close connection
        mysqli_close($link);
