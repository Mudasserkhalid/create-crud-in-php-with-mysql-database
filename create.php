...
$name_err   = $fathername_err   = $address_err = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($input_fathername)) {
        ...
        $name_err = "Please enter a valid fathre name.";
    } else {
        $name = $input_fathername;
    }
    ...
    if (empty($name_err) && empty($fathername_err) && empty($address_err)) {
        // Prepare an insert statement
        $name       = $_POST['name'];
        $fathername = $_POST['fathername'];
		$address    = $_POST['address'];

		mysqli_query($link, "INSERT INTO students (name, fathername, address) VALUES ('$name', '$fathername', '$address')"); 
        // Close connection
        mysqli_close($link);
